...
draft: false
description: 了解RTA项目的申请流程与规定！本文详细介绍了RTA项目的各类申请项，包括新客准入、重启准入、加权加价能力等，明确了申请发起方、接收方以及申请方式和备注信息。同时，阐述了无需申请仅需确认的事项、需评估内容以及不予支持的事项，为相关申请提供清晰的指引。
keywords: [RTA项目, 申请流程, 新客准入, 重启准入, 加权加价能力, DPA决策, 二次请求, 实验层, 申请发起方, 申请接收方, 申请方式]
---
