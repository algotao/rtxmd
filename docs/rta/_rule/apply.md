...
description: 本文详细介绍了客户与服务商接入RTA（实时API）的全流程，包括意向沟通、初步筛选、信息收集、开发验证、压测及正式启动等关键步骤。同时，明确了RTA准入门槛与考核规则，确保参与者满足日均消耗、系统性能等要求，以保障合作的有效性与稳定性。
keywords: [RTA接入,实时API,准入流程,客户接入,服务商接入,意向沟通,初步筛选,信息收集,开发验证,压测验证,正式启动,准入门槛,考核规则,日均消耗,系统性能]
---
...
4. **客户开发**：`客户`根据[RTA官方接口文档](https://docs.qq.com/doc/DVUN6U2NJektwa2ZF)进行开发（也可参考本wiki），线上[自助联调](/docs/rta/tools/debug)工具可满足大部分场景的验证工作。
...
4. **客户开发**：`服务商`根据[RTA官方接口文档](https://docs.qq.com/doc/DVUN6U2NJektwa2ZF)进行开发（也可参考本wiki），线上[自助联调](/docs/rta/tools/debug)工具可满足大部分场景的验证工作。
...
[【在线文档，仅员工可访问】](https://doc.weixin.qq.com/doc/w3_ADQAPgbdAFwEpcm1kZOSdOntHfWjO?scode=AJEAIQdfAAofH5ZTobADQAPgbdAFw)

|  信息项 | 信息内容 | 必填项 | 备注 |
|  ----  | ---- | ---- | ---- |
|  RTA全称 | 如"XX有限公司" | 是 | `直客对接`：CRM中的客户名称。`服务商对接`：服务商主体名称 |
